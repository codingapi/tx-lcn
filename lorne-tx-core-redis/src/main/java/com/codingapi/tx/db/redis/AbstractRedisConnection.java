package com.codingapi.tx.db.redis;
 ...
 */
public abstract class AbstractRedisConnection implements RedisConnection,IResource<RedisConnection> {

    protected RedisConnection redisConnection;


    private Logger logger = LoggerFactory.getLogger(AbstractRedisConnection.class);


    protected DataSourceService dataSourceService;

    private ICallClose<AbstractRedisConnection> runnable;
