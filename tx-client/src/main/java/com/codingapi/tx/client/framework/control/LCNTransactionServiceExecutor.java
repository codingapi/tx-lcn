...
import com.codingapi.tx.client.transaction.common.TransactionUnitTypeList;
...
@Component
@Slf4j
public class LCNTransactionServiceExecutor {
    ...
    public Object transactionRunning(TxTransactionInfo info) throws Throwable {
        ...
        // 2. 事务状态抉择器
        LCNTransactionSeparator lcnTransactionSeparator =
                lcnTransactionBeanHelper.loadLCNTransactionStateResolver(info.getTransactionType());

        // 3. 获取事务状态
        LCNTransactionState lcnTransactionState = lcnTransactionSeparator.loadTransactionState(info);

        // 4. 获取bean
        LCNTransactionControl lcnTransactionControl =
