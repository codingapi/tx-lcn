...
import com.codingapi.tx.client.transaction.txc.sql.def.bean.RollbackInfo;
...
@Slf4j
public class TxcStartingTransaction implements LCNTransactionControl {
    ...
    public void postBusinessCode(TxTransactionInfo info) {
        ...
        // 非成功状态。（事务导致）{#link com.codingapi.tx.client.transaction.txc.sql.TxcServiceImpl.lockResource}
