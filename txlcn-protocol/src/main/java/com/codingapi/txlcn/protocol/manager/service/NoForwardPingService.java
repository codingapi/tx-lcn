...
public class NoForwardPingService implements IPingService {
  ...
  public NoForwardPingService(ConnectionService connectionService,
   ...
   * allowed to be propagated,it sends a {@link Pong} message back to the neighbour that has sent
   * the {@link Ping} message to this peer.
   *
