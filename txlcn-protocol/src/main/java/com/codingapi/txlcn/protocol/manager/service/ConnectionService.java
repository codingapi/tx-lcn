...
public class ConnectionService {
  ...
  public ConnectionService(PeerEventLoopGroup peerEventLoopGroup) {
    this(peerEventLoopGroup.getConfig(), peerEventLoopGroup.getNetworkEventLoopGroup(),
        peerEventLoopGroup.getPeerEventLoopGroup(), peerEventLoopGroup.getEncoder());
  }

  private ConnectionService(Config config, EventLoopGroup networkEventLoopGroup,
  ...
  public boolean removeConnection(final Connection connection) {
    ...
    if (removed) {
      ...
      LOGGER.warn("Connection to " + connection.getPeerName()
          + " is not removed since not found in connections!");
    }
