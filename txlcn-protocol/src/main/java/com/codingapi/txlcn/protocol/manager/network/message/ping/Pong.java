...
public class Pong implements TMMessage {
  ...
  public Pong(String pingPeerName, String senderPeerName, String peerName, String serverHost,
      int serverPort, int ttl,
      int hops) {
  ...
  public Pong next(final String thisPeerName) {
    return ttl > 1 ? new Pong(pingPeerName, thisPeerName, peerName, serverHost, serverPort, ttl - 1,
        hops + 1) : null;
  }
