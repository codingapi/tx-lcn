...
public class JoinGroupExecuteService implements RpcExecuteService {
    ...
    public Serializable execute(TransactionCmd transactionCmd) throws TxManagerException {
        try {
            ...
            txLogger.txTrace(transactionCmd.getGroupId(), joinGroupParams.getUnitId(), "start join group");
            ...
            txLogger.txTrace(transactionCmd.getGroupId(), joinGroupParams.getUnitId(), "over join group");
